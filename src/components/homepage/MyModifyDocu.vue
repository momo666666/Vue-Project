...
<script>
  ...
  export default {
    ...
    computed: {
      requestMyModifyDocuParams () {   // 请求我修改的文档的参数
        return {
    ...
    methods: {
      ...
      handleCurrentChange (val) {
        ...
        this.requestMyModifyDocu()
        console.log(`当前页: ${val}`)
      },
      requestMyModifyDocu () {
        editorApi.getMyModifyDocu(this.requestMyModifyDocuParams).then(res => {
          console.log(`getMyModifyDocu`)
    ...
    mounted () {
      this.requestMyModifyDocu()
      console.log(`requestMyModigyDocu`)
